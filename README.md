...
As a team of 10 people coming from various career branches (UX, artists, game design, management, programming and sound design), we have 4 months starting October 2024 to produce a polished DEMO for Ar Mare. We are working with Unreal Engine 5, using both Blueprints and C++.
